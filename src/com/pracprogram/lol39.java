...
class Developer {
	...
	Developer(String name, int DeveloperId,int qid)
	{
...
class DeveloperDaoImpl implements DeveloperDao {
	...
	public DeveloperDaoImpl()
	{
		...
		Developer Developer1 = new Developer("Kushagra", 0,90);
		Developer Developer2 = new Developer("Vikram", 1,97);
	...
	public void updateDeveloper(Developer Developer)
	{
		...
		System.out.println("DeveloperId "
						+ Developer.getDeveloperId()
						+ ", updated in the database"+Developer.getQid());
	}
}
